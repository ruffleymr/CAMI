...
plot(sample.sizes/2, phy.error, type = "l", lty = 3, pch=22, lwd =lwd, ylab= "Error Rate", xlab = "Community Sample Size", ylim = c(0,1), bty="l", col="black", cex.lab=1)
points(sample.sizes/2, tr.error, type = "l", pch=23, lty = 5, lwd = lwd,col="gray40")
...
legend("topright", legend = c("Disp.Phy", "Disp.Traits", "ABC", "RF"), lty = c(3,5,1,2), bty="n", 
